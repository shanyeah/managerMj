...
public class CustomDatePicker {
    ...
    private boolean spanYear, spanMon, spanDay, spanHour, spanMin,sameDay;
    ...
    private void initParameter() {
        ...
        sameDay = endCalendar.getTimeInMillis()-startCalendar.getTimeInMillis()<86400000*5;
    ...
    private void initTimer() {
        ...
        if(sameDay){
            ...
            if(spanDay)day.add(formatTimeUnit(endDay));
    ...
    private void monthChange() {
        ...
        if(sameDay){
            month.add(formatTimeUnit(startMonth));
        }else if (selectedYear == startMonth) {
            for (int i = startMonth; i <= MAX_MONTH; i++) {
                month.add(formatTimeUnit(i));
            }
