package com.imovie.mogic.card.fragment;
...
import com.imovie.mogic.card.MemberChargeActivity;
import com.imovie.mogic.card.MemberPayActivity;
import com.imovie.mogic.card.MemberUpgradeActivity;
	...
	private void setListener() {
		tvMemberPay.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(getContext(), MemberPayActivity.class);
		...
		tvChargeMoney.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(getContext(), MemberChargeActivity.class);
				startActivity(intent);
		...
		rlMoneyAccount.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
//				Intent intent = new Intent(getContext(), UpdateMyInfoActivity.class);
//				intent.putExtra("type", UpdateMyInfoActivity.MSG_MONEY);
//				startActivity(intent);
			}
		});
		...
		rlGiveAccount.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
//				Intent intent = new Intent(getContext(), UpdateMyInfoActivity.class);
//				intent.putExtra("type", UpdateMyInfoActivity.MSG_GIVE);
//				startActivity(intent);
			}
		});
