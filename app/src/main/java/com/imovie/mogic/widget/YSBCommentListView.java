 ...
 */
public class YSBCommentListView extends RelativeLayout implements IPageList, IEmptyList, IPageHint {
    // view
    public PageListView lvPageListView;
    ...
    public YSBCommentListView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initLayout();
    }

    public YSBCommentListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initLayout();
    }

    public YSBCommentListView(Context context) {
        super(context);
        initLayout();
    }
...
//                tvPageTips.setVisibility(scrollState == SCROLL_STATE_IDLE ? GONE : VISIBLE);
    ...
    public void scrollListBy(int offset){
        lvPageListView.scrollListBy(offset);
    }
