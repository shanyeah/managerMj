...
public class AttendMonthActivity extends AppCompatActivity implements OnCalendarClickListener {
...
//    final List<Integer> days = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.attend_month_activity);
        initView();
        setView();
        getMyCalendar(date);
    }
...
//                adapter.list.add(clockModel);
    ...
    private static class UIHandler extends Handler {
        private final WeakReference<AttendMonthActivity> activity;
        public UIHandler(AttendMonthActivity act) {
            super();
            activity = new WeakReference<AttendMonthActivity>(act);
        }
