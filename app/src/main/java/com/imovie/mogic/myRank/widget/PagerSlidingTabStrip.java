 ...
 *
 * 使用方法：
 *  通过setViewPager(...) 与ViewPager关联
 * 常改属性：
 * selectedTabTextColor 已选择tab项的文字颜色
 *  pstsdividercolor   选项卡之间的分隔颜色
 *	pstsindicatorcolor 滑动指示器颜色
 *	pstsindicatorheight 滑动指示器高度
 *	pstsunderlinecolor 在视图的底部的全宽度的线颜色
 *	pstsunderlineheight 在视图的底部的全宽度的线高度
 * tab项内容：
 *  tab项可为文字,通过关联ViewPager的getAdapter().getPageTitle(...)方法。设置未选择的文字颜色setTextColorResource(), 已选择的文字颜色为属性app:selectedTabTextColor
 *  tab项可为图片,关联ViewPager的Adapter需实现IconTabProvider接口
 * .
 *  不常改属性：
 *  pstsdividerpadding顶部和底部填充的分频器
 *	pststabpaddingleftright左、右填充每个选项卡
 *	pstsscrolloffset 卷轴被选择的标签的偏移
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	protected int dividerPadding = 12;
	protected int tabPadding = 24;
	private int dividerWidth = 1;

	protected int tabTextSize = 12;
	protected int tabTextColor = 0xFF666666;
	protected int selectedTabTextColor = 0xFF666666;
	protected Typeface tabTypeface = null;
	protected int tabTypefaceStyle = Typeface.NORMAL;
