...
public class TakePhotoPopupWindow {
    ...
    public TakePhotoPopupWindow(Context context, OnPhotoPopupWindowItemClickListener listener) {
    ...
    private View initPopupView() {
        ...
        View popupView = LayoutInflater.from(context).inflate(R.layout.popupwindow_chosoe_picture, null);
