...
import com.imovie.mogic.myRank.ChargeDetailActivity;
...
public class ChargeRecordFragment extends Fragment {
	...
	public void getChargeList(){
		...
		RankWebHelper.getChargeRecord(page,lvRatingList.getPageSize(),new IModelResultListener<OrderRecord>() {
			@Override
