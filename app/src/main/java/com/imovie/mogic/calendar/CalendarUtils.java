package com.imovie.mogic.calendar;
...
public class CalendarUtils {
    ...
    public List<MonthDayModel> days = new ArrayList<>();
    ...
    public List<MonthDayModel> addTaskHintsDay(int year, int month, List<MonthDayModel> days) {
        this.days = days;
        return days;
    }
